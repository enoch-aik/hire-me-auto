...
class _CheckboxPainter extends ToggleablePainter {
  ...
  Rect _outerRectAt(Offset origin, double t) {
    ...
    final double size = (_kEdgeSize - inset * _kStrokeWidth) + 1.0;
    final Rect rect =
  ...
  Color? _colorAt(double t) {
    ...
    return t >= 0.25
        ? activeColor
        : Color.lerp(Colors.black87, activeColor, t * 4.0);
  ...
  void _drawBorder(Canvas canvas, Rect outer, double t, Paint paint) {
    ...
    if (side == null) {
      resolvedShape = resolvedShape!
          .copyWith(side: BorderSide(width: 1, color: paint.color));
    }
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    ///
    const Offset end = Offset(_kEdgeSize * 0.85, _kEdgeSize * 0.35);
